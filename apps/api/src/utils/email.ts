...
function getResendClient(): Resend {
  if (!resendInstance) {
    ...
    resendInstance = new Resend(apiKey || 're_dummy_key_for_development')
  }
                    ...
                    <tr>
                      <td style="padding: 30px 40px; background-color: #f9fafb; border-radius: 0 0 8px 8px; text-align: center;">
                        <p style="margin: 0; color: #6b7280; font-size: 14px; line-height: 20px;">
                          &copy; ${new Date().getFullYear()} ExtraTracker. All rights reserved.
                        </p>
...
export async function sendPaymentReminderEmail({
  ...
  try {
    ...
    const urgencyText = daysUntilDue === 0 ? 'Due Today!' : daysUntilDue === 1 ? 'Due Tomorrow!' : daysUntilDue < 0 ? `${Math.abs(daysUntilDue)} days overdue` : `Due in ${daysUntilDue} days`
                          ...
                          <tr>
                            <td style="padding: 24px;">
                              <div style="margin-bottom: 16px;">
                                <div style="color: #6b7280; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 4px;">EXPENSE</div>
                                <div style="color: #111827; font-size: 20px; font-weight: 700;">${expenseTitle}</div>
                              </div>
                              <div style="margin-bottom: 16px;">
                                <div style="color: #6b7280; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 4px;">AMOUNT</div>
                                <div style="color: #111827; font-size: 32px; font-weight: 700;">${formattedAmount}</div>
                              </div>
                              <div style="margin-bottom: 16px;">
                                <div style="color: #6b7280; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 4px;">DUE DATE</div>
