...
-- AddForeignKey
ALTER TABLE "Expense" ADD CONSTRAINT "Expense_paymentCardId_fkey" FOREIGN KEY ("paymentCardId") REFERENCES "PaymentCard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
